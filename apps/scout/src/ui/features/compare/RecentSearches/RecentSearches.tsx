    ...
    <div>
      <div className="mb-2 flex items-baseline justify-between px-1">
        ...
        <button
          ...
          className="text-[11px] font-medium text-zinc-500 hover:text-rose-600"
        >
          Limpiar historial
        </button>
      </div>
          ...
          return (
            <li key={e.key}>
              <button
                ...
                className="group flex w-full items-center gap-3 rounded-xl border border-zinc-200 bg-white p-3 text-left transition-all hover:border-teal-400 hover:shadow-sm"
              >
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-zinc-100 text-zinc-500 group-hover:bg-teal-50 group-hover:text-teal-600">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    {e.report && (
                      <span
                        className="inline-flex shrink-0 items-center gap-0.5 rounded-full bg-emerald-100 px-1.5 py-0.5 text-[9px] font-semibold text-emerald-800"
                ...
                <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0 text-zinc-400 group-hover:translate-x-0.5 group-hover:text-teal-600" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="m9 6 6 6-6 6" />
                </svg>
              </button>
            </li>
