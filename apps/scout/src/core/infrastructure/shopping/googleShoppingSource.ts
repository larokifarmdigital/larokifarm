...
} from '@/core/domain/ports/ShoppingPriceSource';
...
async function search(input: ShoppingSearchInput): Promise<ShoppingSearchResult> {
...
export const googleShoppingSource: ShoppingPriceSource = {
  search,
};
